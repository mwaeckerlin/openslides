...
ENV OPENSLIDES_USER_DATA_PATH "/var/lib/openslides"
...
RUN apt-get update && apt-get install -y python3 python3-setuptools python3-dev gcc
ENV VERSION "2.1.1"
...
RUN adduser --system --disabled-login --disabled-password --home /var/lib/openslides openslides
USER openslides
